...
관련 문서: [[Web/03_LLM/Skill_개요]], [[Web/02_기능/식물_생성]], [[Plant_JSON]], [[match_plant]]

---

## 설명(LLM 용)

[[match_plant]]에서 적절한 후보가 없거나 사용자가 명시적으로 새 분야를 원할 때 호출. 호출 전에 반드시 사용자 동의를 받는다.
...
- 이름이 비어 있지 않고 1~24자.
- 동일 이름의 활성 식물 존재 여부 — 있으면 [[match_plant]]로 안내 후 실패.
