...
관련 문서: [[Web/03_LLM/LLM_흐름]], [[Web/03_LLM/Skill_개요]], [[Web/03_LLM/시스템_프롬프트]], [[클래스_함수_사전]]
...
- [[Web/03_LLM/시스템_프롬프트]] 템플릿에 변수를 채워 최종 프롬프트 메시지를 만든다.
- 키: `build_system`, `build_tools_catalog`, `embed_context`.

### SkillRegistry

- [[Web/03_LLM/Skill_개요]]의 Skill 객체들을 등록/조회/dispatch.
...
- 사용자가 [[Web/01_페이지/설정#2-AI-설정]]에서 선택할 모델 목록.
