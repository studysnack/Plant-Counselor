...
관련 문서: [[Web/01_페이지/홈]], [[Web/01_페이지/식물]], [[Web/01_페이지/설정]], [[Web/01_페이지/공통_AI대화창]], [[클래스_함수_사전]], [[디자인_시스템]], [[픽셀_에셋]]
...
- [[클래스_함수_사전#HomeScene]] — [[Web/01_페이지/홈]]
- [[클래스_함수_사전#PlantsScene]] — [[Web/01_페이지/식물]] 목록
- [[클래스_함수_사전#PlantDetailScene]] — 식물 상세
- [[클래스_함수_사전#SettingsScene]] — [[Web/01_페이지/설정]]

## 공통 오버레이

- [[클래스_함수_사전#ChatWidget]] — [[Web/01_페이지/공통_AI대화창]]. 어느 Scene 위에서도 열림.
