...
- [[Skills/delete_plant]]
- [[Skills/create_bud]]
- [[Skills/update_bud_status]]
- [[Skills/update_bud_progress]]
- [[Skills/set_deadline]]
- [[Skills/abandon_bud]]
- [[Skills/harvest_bud]]
- [[Skills/list_plants]]
...
- 매 LLM 호출 시 [[클래스_함수_사전#SkillRegistry]].`build_catalog()`이 모든 Skill의 이름/설명/파라미터 스키마를 JSON으로 만들어 [[시스템_프롬프트#5-Skill-카탈로그]] 자리에 삽입.
