...
관련 문서: [[Skill_개요]], [[홈#2-오늘의-정원-메시지]], [[알림]]
...
- `ok`: bool
- `data.stats`: [[Skills/get_statistics]] 결과 요약
...
[[클래스_함수_사전#GardenStateManager]].`build_briefing(as_of)`. 내부적으로 [[Skills/list_buds]]과 동일한 [[BudManager]].`list`를 사용.
