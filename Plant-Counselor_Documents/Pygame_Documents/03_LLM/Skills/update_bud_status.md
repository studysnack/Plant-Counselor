...
관련 문서: [[Skill_개요]], [[봉우리_생애주기]], [[상태_자동전이]]

---

## 설명(LLM 용)

사용자가 진행 단계를 알리거나 시들었다가 다시 시작한다고 말할 때 호출. 완료/포기는 별도 Skill([[Skills/harvest_bud]], [[Skills/abandon_bud]])이 더 명확하다.
...
- 봉우리 존재 여부.
- 전이 적법성: 정상 흐름 외의 전이는 [[봉우리_생애주기#분기-흐름]] 규칙을 따른다. 위반 시 실패.
